...
class TestBirthAndDeathDateValidation(unittest.TestCase):
    ...
    def test_invalid_birth_valid_death(self):
        ...
        self.assertFalse(validBirthAndDeath(birth, death)) #invalid birth date is false
    ...
    def test_valid_birth_missing_death(self):
        ...
        self.assertTrue(validBirthAndDeath(birth, death)) #valid birth no death is true
